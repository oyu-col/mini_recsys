...
class RankerTrainer:
    ...
    def train_catboost(
        ...
        if CatBoost is None or Pool is None:
            raise ImportError("catboost is required for model_type='catboost'")
    ...
    def train_catboost_ranker(
        ...
        if CatBoost is None or Pool is None:
            raise ImportError("catboost is required for model_type='catboost_ranker'")
