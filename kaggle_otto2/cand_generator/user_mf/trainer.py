...
from kaggle_otto2.util import EvaluateUtil, FileUtil, GlobalUtil, TimeUtil
...
class UserMFTrainer:
    ...
    def train(self, epoch, train_dl):
        device = GlobalUtil.get_torch_device()
        self.model.train()
    ...
    def load_model(self, data_dir: Path):
        ...
        self.model.load_state_dict(
            torch.load(data_dir / "model.pt", map_location=GlobalUtil.get_torch_device())
        )
